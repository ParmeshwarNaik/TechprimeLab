...
import "./Inserproject.css"
const Insertproject = () => {

  const LoginBg=()=>{
    return (
      <div className='insert-loginbg'>
        <svg viewBox="0 0 1066 572" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
  ...
  const Logo=()=>{
    return (
      <div className='logo-create'>
        <svg width="85px" height="76px" viewBox="0 0 85 76" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
  ...
  return (
    <div className='insertproject'>
      {LoginBg()} 
      <div className='inserproject-nav'>
        <div className='backey'>
         <a href='#'>{`<`}</a> <span>    </span>
         <span>create project</span>          
        </div>
        <div className='logo-create' >{Logo()}</div>

      </div>

      <div className='insertproject-form'>
        <div id='form-head'>
         <textarea typeof="text" placeholder='Enter Project theme'/>
       <button>Save Changes</button>         
        </div>
        <div class="grid-container">
  <div class="grid-item"><label>Reason</label><br/><input type="text" name="option1"/></div>
  <div class="grid-item"><label>Type</label><br/><input type="text" name="option2"/></div>
  <div class="grid-item"><label>Division</label><br/><input type="text" name="option3"/></div>
  <div class="grid-item"><label>Category</label><br/><input type="text" name="option4"/></div>
  <div class="grid-item"><label>Priority</label><br/><input type="text" name="option5"/></div>
  <div class="grid-item"><label>Department</label><br/><input type="text" name="option6"/></div>
  <div class="grid-item"><label>Start Date as per Project Plan</label><br/><input type="date" name="option7"/></div>
  <div class="grid-item"><label>End Date as per Project Plan</label><br/><input type="date" name="option8"/></div>
  <div class="grid-item"><label>Location</label><br/><input type="text" name="option9"/></div>
</div>
