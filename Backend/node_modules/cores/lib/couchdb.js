...
module.exports = function(db) {
  ...
  var dbUrl = typeof db === 'string' ? db : (db && db.url) ? db.url : null;

  var auth = db && db.user && db.pass ? { user: db.user, pass: db.pass } : '';

  // Check if db.url is defined and not an empty string
if (!db || !db.url) {
  throw new Error('No couchdb url given');
}

// Then use db.url in your code
var dbUrl = db.url;
var auth = db && db.user && db.pass ? { user: db.user, pass: db.pass } : '';
// ... rest of your code
